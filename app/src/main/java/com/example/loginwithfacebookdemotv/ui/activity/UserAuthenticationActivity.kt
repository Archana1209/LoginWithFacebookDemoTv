...
import com.example.loginwithfacebookdemotv.databinding.UserAuthenticationActivityBinding
...
class UserAuthenticationActivity : FragmentActivity(), UserAuthenticationCodeCallback {
    ...
    private lateinit var userAuthenticationActivityBinding: UserAuthenticationActivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userAuthenticationActivityBinding = DataBindingUtil.setContentView(this, R.layout.user_authentication_activity)
        userAuthenticationActivityViewModel =
            ViewModelProviders.of(this).get(UserAuthenticationActivityViewModel::class.java)
        userAuthenticationActivityBinding.rlFacebookLogin.requestFocus()
        userAuthenticationActivityBinding.rlFacebookLogin.setOnClickListener {
            ...
            userAuthenticationActivityViewModel.getFacebookLoginStatus(this@UserAuthenticationActivity, it1)
                .observe(this@UserAuthenticationActivity, Observer {
                    ...
                    if (it != null) {
                        ...
                        Toast.makeText(this@UserAuthenticationActivity, "Something went wrong", Toast.LENGTH_SHORT)
                            .show()
                    }
                })
        }
