...
class ApiManager private constructor() {
    ...
    private var mFacebookApiInterface: FacebookApiInterface? = null
    ...
    private fun createNontonApiClient() {
        ...
        mFacebookApiInterface = getRetrofitClient().create(FacebookApiInterface::class.java)
    }
    ...
    fun getFacebookLogin(accessToken: String, scope: String): Observable<FacebookLoginResponse>? {
        ...
        return mFacebookApiInterface?.getFacebookLogin(accessToken, scope)
    }

    fun getFacebookLoginStatus(accessToken: String, code: String): Observable<LoginStatusResponse>? {
        Log.d(TAG, " getFacebookLoginStstus")
        return mFacebookApiInterface?.getFacebookLoginStatus(accessToken, code)
    }
    ...
    fun getFacebookUserProfile(fields: String, accessToken: String): Observable<FacebookUserProfileResponse>? {
        ...
        return mFacebookApiInterface?.getFacebookUserProfile(fields, accessToken)
    }
